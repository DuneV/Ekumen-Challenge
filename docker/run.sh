...
[[ "$BUILD" = true ]] && docker compose build challenges-dev

PRIVILEGED_CONTAINER=$PRIVILEGED_CONTAINER USERID=$(id -u) GROUPID=dialout docker compose run --rm challenges-dev
